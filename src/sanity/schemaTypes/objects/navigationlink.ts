...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "object",
      description:
        "Select an internal page or provide an external URL for the link.",
      validation: (Rule) =>
        Rule.required().custom((value, context) => {
          ...
          const hasExternalUrl =
            Array.isArray(externalUrl) &&
            externalUrl.some((item) => !!item.value);
      ...
      fields: [
        ...
        defineField({
          ...
          description:
            "Link to an external website or a relative path (e.g., /about-us).",
        }),
      ],
    }),
  ],
